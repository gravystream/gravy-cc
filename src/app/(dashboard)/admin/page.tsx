...
export default async function AdminDashboardPage() {
  ...
  return (
    <div>
      ...
      <div className="grid stagger-children grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {stats.map((stat) => (
          <div
            key={stat.label}
            className="bg-gray-900 card-hover border border-gray-800 rounded-xl p-6"
          >
