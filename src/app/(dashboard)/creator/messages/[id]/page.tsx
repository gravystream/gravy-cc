...
export default async function CreatorChatPage({ params }: { params: { id: string } }) {
  ...
  if (!conv || conv.creator.user.id !== userId) notFound();
  ...
  const otherName = conv.brand.companyName ?? conv.brand.user.name ?? "Brand";
