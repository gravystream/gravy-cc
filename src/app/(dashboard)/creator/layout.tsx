...
const navLinks = [
  ...
  { href: "/creator/links", label: "Links & Metrics", icon: "🔗" },
  { href: "/creator/ab-variants", label: "A/B Variants", icon: "⇄" },
  { href: "/creator/score", label: "My Score", icon: "⭐" },
  { href: "/creator/profile", label: "Profile", icon: "👤" },
];

const bottomTabs = [
  { href: "/creator", label: "Home", icon: "📊" },
  { href: "/creator/briefs", label: "Briefs", icon: "📋" },
  { href: "/creator/earnings", label: "Earnings", icon: "💰" },
  { href: "/creator/analytics", label: "Analytics", icon: "📈" },
  { href: "/creator/profile", label: "Profile", icon: "👤" },
];
