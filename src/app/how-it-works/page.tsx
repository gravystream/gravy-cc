...
import { Star, Zap, Shield, DollarSign, Video, Users, TrendingUp, CheckCircle2, ArrowRight } from "lucide-react";
...
const FEATURES = [
  { icon: <Zap className="w-5 h-5" />,       title: "AI Quality Gate",         desc: "Every submission is scored 0-100 on video quality, audio clarity and brief relevance. Only the best reach brands.",                          color: "#D4A843" },
  { icon: <Shield className="w-5 h-5" />,    title: "Escrow Protection",       desc: "Brands deposit funds upfront. Creators work with confidence knowing payment is secured and held until approval.",                           color: "#22C55E" },
  { icon: <DollarSign className="w-5 h-5" />,title: "Flexible Campaigns",      desc: "Post open briefs to receive many proposals, or direct hire a specific creator you love — both with escrow.",                               color: "#60A5FA" },
  { icon: <Video className="w-5 h-5" />,     title: "TikTok-Style Discovery",  desc: "Browse creator talent like a TikTok feed. Filter by niche, location, rating, price and platform specialty.",                               color: "#EF4444" },
  { icon: <Users className="w-5 h-5" />,     title: "Proposal Pitching",       desc: "Creators record video pitches explaining their creative approach — brands see passion, not just a quote.",                                  color: "#A78BFA" },
  { icon: <TrendingUp className="w-5 h-5" />,title: "Real-Time Analytics",     desc: "Track campaign performance, creator ratings, spend history and ROI — all in one beautiful dashboard.",                                     color: "#F59E0B" },
];
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A]">
      ...
      <section className="relative pt-24 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#1E1E1E] border border-[#2D2D2D] text-xs text-[#D4A843] font-medium mb-8">
            ...
            <h1
              className="font-quicksand font-bold tracking-tight"
            ...
            <p className="mt-8 text-lg text-[#808080] max-w-2xl mx-auto leading-relaxed">
     ...
     0      </div>
          ...
          {/* Stats bar */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-[#1E1E1E] rounded-2xl overflow-hidden mb-16">
            {STATS.map((s) => (
      ...
      <section className="py-24 border-t border-[#1E1E1E]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-display-sm text-white font-quicksand mb-4">
              Two ways to use Novaclio.<br />Both powered by AI.
            </h2>
          </div>
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="card p-8">
              ...
              <div className="space-y-5">
                {HOW_IT_WORKS.creators.map((step) => (
              ...
              <div className="mt-8">
                <Link href="/signup/creator">
                  <Button variant="primary" size="md" className="w-full">Join as Creator ✦</Button>
                </Link>
              </div>
            </div>
            ...
            <div className="card p-8 border-[#D4A843]/30">
              ...
              <div className="mt-8">
                <Link href="/signup/brand">
                  <Button variant="gold" size="md" className="w-full">Start Finding Creators →</Button>
                </Link>
              </div>
            </div>
          </div>
